...
describe('[Challenge] The rewarder', function () {
    ...
    it('Execution', async function () {
        const Attacker = await ethers.getContractFactory('TheRewarderPoolAttacker', player);
        const attacker = await Attacker.connect(player).deploy(liquidityToken.address, rewardToken.address, rewarderPool.address, flashLoanPool.address);
